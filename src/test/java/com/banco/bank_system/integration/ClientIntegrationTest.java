...
class ClientIntegrationTest {
    ...
    void shouldChangeClientEmail() throws Exception {
        ...
        ChangeClientEmailRequest request = new ChangeClientEmailRequest("novo@gmail.com");
        ...
        ClientEntity updated = clientRepository.findByCpf(client.getCpf().value()).orElseThrow();
